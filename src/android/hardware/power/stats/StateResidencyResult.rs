...
use alloc::boxed::Box;
#[derive(Debug)]
pub struct r#StateResidencyResult {
  pub r#id: i32,
  pub r#stateResidencyData: alloc::vec::Vec<crate::mangled::_7_android_8_hardware_5_power_5_stats_14_StateResidency>,
}
impl Default for r#StateResidencyResult {
  fn default() -> Self {
    Self {
      r#id: 0,
      r#stateResidencyData: Default::default(),
    }
  }
}
impl binder::Parcelable for r#StateResidencyResult {
  fn write_to_parcel(&self, parcel: &mut binder::binder_impl::BorrowedParcel) -> core::result::Result<(), binder::StatusCode> {
    parcel.sized_write(|subparcel| {
      ...
      subparcel.write(&self.r#stateResidencyData)?;
      Ok(())
    })
  }
  fn read_from_parcel(&mut self, parcel: &binder::binder_impl::BorrowedParcel) -> core::result::Result<(), binder::StatusCode> {
    parcel.sized_read(|subparcel| {
      ...
      if subparcel.has_more_data() {
        self.r#stateResidencyData = subparcel.read()?;
      }
      Ok(())
    })
  }
}
binder::impl_serialize_for_parcelable!(r#StateResidencyResult);
binder::impl_deserialize_for_parcelable!(r#StateResidencyResult);
impl binder::binder_impl::ParcelableMetadata for r#StateResidencyResult {
  fn get_descriptor() -> &'static str { "android.hardware.power.stats.StateResidencyResult" }
  fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
}
pub(crate) mod mangled {
 pub use super::r#StateResidencyResult as _7_android_8_hardware_5_power_5_stats_20_StateResidencyResult;
}
